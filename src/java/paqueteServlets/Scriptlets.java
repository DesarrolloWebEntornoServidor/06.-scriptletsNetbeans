...
public class Scriptlets extends HttpServlet {
    ...
    private static final String FICHERO = "paises.csv";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        cargarPaisesFichero(request,out, FICHERO);
    ...
    private void cargarPaisesFichero(HttpServletRequest request,PrintWriter out, String nombre) {
        String directorio = request.getServletContext().getRealPath("/ficheros/");
        File fichero = new File(directorio,nombre);
        //out.println("fichero "+directorio+fichero.getName()+" "+fichero.exists());
        try (BufferedReader br = new BufferedReader(new FileReader(fichero))) {
            
            String linea;
            while ((linea = br.readLine()) != null) {     
                //out.println("linea "+linea);
                StringTokenizer st = new StringTokenizer(linea, ";");
                arrayValoresYEtiquetas.put(st.nextToken(), st.nextToken());
            }
